...
def api_he_cortes_list():
    ...
    if contrato_id:
        # Incluir cortes del contrato específico Y cortes globales (contrato_id=null)
    ...
    for r in registros:
        ...
        if cid not in contratos:
            contratos[cid] = {"nombre": cname, "contrato_id": cid,
                               ...
                               "hrs_rep": 0, "hrs_auth": 0, "hrs_pend": 0, "tecnicos": {}}
        ...
        es_pendiente = not r.estado or r.estado.upper() == "PENDIENTE"
        ...
        if es_pendiente:
            contratos[cid]["valor_pend"] += vr
            contratos[cid]["hrs_pend"]   += hrs_rep
